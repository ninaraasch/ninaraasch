      ...
      <div className="grid grid-cols-2 gap-5 px-[var(--page-margin)] pb-5 nav:grid-cols-5 nav:pb-[30px]">
        {sections.map((section) => (
          ...
          >
            ...
            <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center gap-1.5 bg-ink/45 p-4 text-center text-paper opacity-100 transition-opacity duration-300 ease-out nav:opacity-0 nav:group-hover:opacity-100">
              {section.campaign ? (
