...
export function Contact({ content }: { content: ContactContent }) {
  return (
    ...
    >
      <div className="flex flex-col gap-5 px-[var(--page-margin)] pb-5 nav:pb-[30px]">
        <div className="flex flex-col gap-5 nav:flex-row nav:gap-0">
        ...
        <div className="flex justify-end">
          <Link href="/imprint" className="underline-reveal">
            imprint
          </Link>
        </div>
      </div>
